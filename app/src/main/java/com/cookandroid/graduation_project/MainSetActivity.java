...
public class MainSetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraButton.setOnClickListener(v -> startActivity(new Intent(MainSetActivity.this, com.cookandroid.graduation_project.DetectorActivity.class)));
        ...
        this.sourceBitmap = Utils.getBitmapFromAsset(MainSetActivity.this, "test_image.jpg");
